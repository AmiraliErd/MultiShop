...
SECRET_KEY = 'django-insecure-&9u1+q#ho247-mo(z$f$a4z=%5ql#(r$y=s(zyj+z2v9(g%48y'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'context_processors.context_processors.cart_counter',
                # 'context_processors.context_processors.navbar',
            ],
        },
    },
]
